...
onload = () => {
    ...
    function sendRequest(formData) {
        fetch(backendAddress + 'usuarios/cadastro/', {
            ...
            function looksLikeDuplicateMessage(msgs) {
                ...
                return msgs.some((m) => typeof m === 'string' && re.test(m));
            }
            if (erro.data) {
            ...
            const fallback = ((_a = erro.data) === null || _a === void 0 ? void 0 : _a.message) || ((_b = erro.data) === null || _b === void 0 ? void 0 : _b.error) || 'Erro ao realizar cadastro. Tente novamente.';
